...
def normal_place():
    raw_text = """
    <html><head></head><body data-new-gr-c-s-check-loaded="9.57.0" data-gr-ext-installed=""><div class="zamknij" title="Zamknij">
...
<div class="dane-icon">
<span class="fa-stack fa-2x"> <em class="fa fa-square-o fa-stack-2x"></em> 
...
<head></head>
<body data-new-gr-c-s-check-loaded="9.57.0" data-gr-ext-installed=""><div class="zamknij" title="Zamknij">
	<button aria-label="zamknij" type="button" class="btn p-0" onclick="mapa.zamknijListe();">
		<em class="fa fa-lg fa-times"></em>
	</button>
</div>
...
class TestQuotesSpider:
    def test_parse_name(self, normal_place):
        assert QuotesSpider().parse(normal_place, category='test') == \
               {'name': 'Miejski Ośrodek Pomocy Społecznej w Zabłudowie'}
