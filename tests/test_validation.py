...
@pytest.mark.parametrize('phone, country, expected,', [
    ('(+48) 792 568 561', 'Poland', '+48 792568561'),
    ('792 568 561', 'Poland', '+48 792568561'),
    ('(+48) 792 568 561', None, '+48 792568561'),
    ('792 568 561', None, '')
])
...
@pytest.mark.parametrize('phone, country, expected,', [
    ...
    ('+48 81 5666060', 'Poland', '+48 815666060'),
    ('+48 56 678 12 12', 'Poland', '+48 566781212'),
    ('+48 054-2842-252', 'Poland', '+48 542842252'),
    ('+48 54 230-53-47', 'Poland', '+48 542305347'),
    ('+48 (0 44) 616 11 60', 'Poland', '+48 446161160'),
    ('+48 044 7102368', 'Poland', '+48 447102368'),
    ('+48 (14) 671-31-20', 'Poland', '+48 146713120'),
    ('+48 (0-24)', 'Poland', ''),
    ('+48 24 356 22 02  024 356 29 09', 'Poland', '+48 243562202'),
    ('+48 468302636\n468302648\n46 830', 'Poland', '+48 468302636'),
    ('+48 29 752-25-14   118', 'Poland', '+48 297522514'),
    ('+48 14 6761067       146761140', 'Poland', '+48 146761067'),
    ('+48 17 7445715 7445717 7445756', 'Poland', '+48 177445715'),
    ('+48 (15) 8643058, (15) 8665099', 'Poland', '+48 158643058'),
    ('+48 25 781 60 74, 25 787 73 50', 'Poland', '+48 257816074'),
    ('+48 22 510 98 03-19 foo', 'Poland', '+48 225109803'),
    ('foo +48 22 510 98 03-19 bar', 'Poland', '+48 225109803'),
    ('542851327', None, '')
])
def test_phone_validation_with_country_edge_casese(phone, country, expected):
    real = sanitise_phone(phone, country)
    assert real == expected
